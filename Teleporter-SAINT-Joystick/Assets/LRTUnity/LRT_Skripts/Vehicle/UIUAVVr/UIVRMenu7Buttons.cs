...
public class UIVRMenu7Buttons : UIVrMenuButtons
{
    ...
    override public void setTouchPosition(Vector2 position)
    {
        ...
        if (this.sectorChanged)
        {
            ...
            handleButtonAnimation(buttonDown, 4);
            handleButtonAnimation(buttonLeftDownLeft, 5);
            handleButtonAnimation(buttonLeftTopLeft, 6);
            handleButtonAnimation(buttonTopTopLeft, 7);
        }
    }
